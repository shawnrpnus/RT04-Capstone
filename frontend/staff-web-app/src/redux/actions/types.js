...
export const CREATE_STYLE_QUIZ_QNS = "CREATE_STYLE_QUIZ_QNS";
...
export const SEND_COMPLETED_REFUND_CONFIRMATION = "SEND_COMPLETED_REFUND_CONFIRMATION";
export const SEND_RECEIVED_REFUND_CONFIRMATION = "SEND_RECEIVED_REFUND_CONFIRMATION";


// TRANSACTION
export const RETRIEVE_TRANSACTION_BY_ORDER_NUMBER_SUCCESS =
  "RETRIEVE_TRANSACTION_BY_ORDER_NUMBER_SUCCESS";
export const RETRIEVE_TRANSACTION_BY_TRANSACTION_ID_SUCCESS =
  "RETRIEVE_TRANSACTION_BY_TRANSACTION_ID_SUCCESS";
export const CONFIRM_RECEIVED_TRANSACTION = "CONFIRM_RECEIVED_TRANSACTION";
...
export const RETRIEVE_LOW_STOCK_PRODUCTS = "RETRIEVE_LOW_STOCK_PRODUCTS";

// ANALYTICS
export const RETRIEVE_SALES_BY_DAY = "RETRIEVE_SALES_BY_DAY";
export const RETRIEVE_RESERVATIONS_BY_TIMESLOT = "RETRIEVE_RESERVATIONS_BY_TIMESLOT";
export const RETRIEVE_SALES_BY_CATEGORY = "RETRIEVE_SALES_BY_CATEGORY"
