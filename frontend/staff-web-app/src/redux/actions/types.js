...
// ProductStock
export const RETRIEVE_PRODUCT_STOCK_BY_WAREHOUSE_ID = "RETRIEVE_PRODUCT_STOCK_BY_WAREHOUSE_ID";
export const RETRIEVE_PRODUCT_STOCK_BY_STORE_ID = "RETRIEVE_PRODUCT_STOCK_BY_STORE_ID";
export const UPDATE_PRODUCT_STOCK = "UPDATE_PRODUCT_STOCK";
export const RETRIEVE_ALL_PRODUCT_STOCKS = "RETRIEVE_ALL_PRODUCT_STOCKS";
