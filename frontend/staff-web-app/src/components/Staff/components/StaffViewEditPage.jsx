...
class StaffViewEditPage extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot){
        ...
        if (!prevProps.currentStaff || (prevProps.currentStaff && prevProps.currentStaff.staffId && prevProps.currentStaff.staffId !== this.props.currentStaff.staffId)){
    ...
    handleDelete = staffId => {
        this.props.confirmDialog({ description: "Staff will be deleted permanently" })
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            storeId: (currentStaff && currentStaff.store) ? currentStaff.store.storeId :"",
            departmentName: currentStaff ? currentStaff.department.departmentName:"",
