...
import { retrieveAllLeavesManager } from "../../../redux/actions/leaveActions";
...
class AllLeavesManagerTable extends React.Component {
  componentDidMount() {
    this.props.retrieveAllLeavesManager(this.props.loggedInStaff.staffId);
  }

  render() {
    const data = this.props.allLeavesManager;
    console.log(data);
    return (
      <React.Fragment>
        <div
...
export default connect(
  ...
  withMaterialConfirmDialog(withPage(AllLeavesManagerTable, "Leave Management"))
);
