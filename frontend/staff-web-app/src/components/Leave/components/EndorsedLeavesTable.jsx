...
import {
    approveRejectLeave, retrieveAllEndorsedLeaves
...
class EndorsedLeavesTable extends React.Component {
    ...
    handleApprove = staffLeaveId => {
        ...
        const req = new ApproveRejectLeaveRequest(staffLeaveId, this.props.loggedInStaff.staffId, true);
        this.props.approveRejectLeave(req, this.props.history);
    };

    handleReject = staffLeaveId => {
        const req = new ApproveRejectLeaveRequest(staffLeaveId, this.props.loggedInStaff.staffId, false);
        this.props.approveRejectLeave(req, this.props.history);
    };
                        ...
                        actions={[
                            {
                                ...
                                tooltip: "Approve",
                                onClick: (event, rowData) => this.handleApprove(rowData.staffLeaveId)
                            },
                            {
                                icon:CancelOutlined,
                                tooltip: "Reject",
                                onClick: (event, rowData) => this.handleReject(rowData.staffLeaveId)
                            }
                        ]}
