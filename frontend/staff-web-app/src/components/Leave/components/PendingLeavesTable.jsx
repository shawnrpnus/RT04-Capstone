...
import {
    endorseRejectLeave, retrieveAllPendingLeaves
...
class PendingLeavesTable extends React.Component {
    ...
    handleEndorse = staffLeaveId => {
        ...
        const req = new EndorseRejectLeaveRequest(staffLeaveId, this.props.loggedInStaff.staffId, true);
        this.props.endorseRejectLeave(req, this.props.history);
    };

    handleReject = staffLeaveId => {
        const req = new EndorseRejectLeaveRequest(staffLeaveId, this.props.loggedInStaff.staffId, false);
        this.props.endorseRejectLeave(req, this.props.history);
    };
                        ...
                        actions={[
                            {
                                ...
                                tooltip: "Endorse",
                                onClick: (event, rowData) => this.handleEndorse(rowData.staffLeaveId)
                            },
                            {
                                icon:CancelOutlined,
                                tooltip: "Reject",
