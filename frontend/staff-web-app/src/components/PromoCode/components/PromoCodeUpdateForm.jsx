...
class PromoCodeUpdateForm extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (
            ...
            (prevProps.currentPromoCode &&
                ...
                prevProps.currentPromoCode.promoCodeId !== this.props.currentPromoCode.promoCodeId)
        ) {
            this.setState({
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            originalPercentageDiscount:currentPromoCode ? currentPromoCode.percentageDiscount:""
    ...
    handleSubmit = e => {
        ...
        if(this.state.flatDiscount === 0 && this.state.percentageDiscount === 0){
            ...
            const req = new PromoCodeUpdateRequest(
                newPromoCode
            );
    ...
    render() {
        ...
        const discountPercentage = _.get(this.props.currentPromoCode, "percentageDiscount", "");
            ...
            <form className="material-form">
                ...
                <ButtonToolbar className="form__button-toolbar">
                    ...
                    <Button
                        className="icon"
                        color="danger"
                        onClick={() => this.handleDelete(this.props.currentPromoCode.promoCodeId)}
                    >
                        <p>
                            <DeleteIcon />
                            Delete
