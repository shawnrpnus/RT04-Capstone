...
public class CustomerControllerRoutes {
    ...
    public static final String GET_PROD_VARIANT_STORE_STOCK_STATUS_FOR_CART = "/getProdVariantStoreStockStatusForCart";
    public static final String GET_PROD_VARIANT_STORE_STOCK_STATUS_FOR_RESERVATION = "/getProdVariantStoreStockStatusForReservation";
