...
public class CategoryControllerRoutes {
    public static final String CATEGORY_BASE_ROUTE = "/api/category";
    public static final String CREATE_NEW_CATEGORY = "/createNewCategory";
    public static final String RETRIEVE_ALL_ROOT_CATEGORIES = "/retrieveAllRootCategories";
    public static final String RETRIEVE_ALL_CATEGORIES = "/retrieveAllCategories";
