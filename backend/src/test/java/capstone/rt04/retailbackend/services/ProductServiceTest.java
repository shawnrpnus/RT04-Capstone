...
//    }
    ...
    public void retrieveProductByCriteria() throws Exception {
        ...
        List<Product> productList = productService.retrieveProductByCriteria(category.getCategoryId(), tags, colours, null, BigDecimal.ZERO, BigDecimal.valueOf(300), null,null);
        assertThat(productList.size()).isNotEqualTo(0);
        assertThat(productList.get(0).getProductName()).isEqualTo("Adidas Alpha Bounce");

        productList = productService.retrieveProductByCriteria(category.getCategoryId(), tags, colours, null, BigDecimal.ZERO, BigDecimal.valueOf(300), SortEnum.PRICE_HIGH_TO_LOW,null);
        assertThat(productList.get(0).getProductName()).isEqualTo("Adidas Alpha Bounce");

        productList = productService.retrieveProductByCriteria(category.getCategoryId(), tags, colours, null, BigDecimal.ZERO, BigDecimal.valueOf(300), SortEnum.PRICE_LOW_TO_HIGH,null);
        assertThat(productList.get(0).getProductName()).isEqualTo("Fila Disruptor II");

        colours.remove("White");
        colours.remove("Pink");
        colours.add("Red");
        productList = productService.retrieveProductByCriteria(category.getCategoryId(), tags, colours, null, BigDecimal.ZERO, BigDecimal.valueOf(300), null,null);
        ...
        colours.add("White");
        tags.remove(tag1);
        productList = productService.retrieveProductByCriteria(category.getCategoryId(), tags, colours, null, BigDecimal.ZERO, BigDecimal.valueOf(500), null,null);
        ...
        colours.add("Pink");
        colours.add("Red");
        productList = productService.retrieveProductByCriteria(category.getCategoryId(), tags, colours, null, BigDecimal.valueOf(500), BigDecimal.valueOf(300), null,null);
        // Wrong min price
         assertThat(productList.size()).isEqualTo(0);
